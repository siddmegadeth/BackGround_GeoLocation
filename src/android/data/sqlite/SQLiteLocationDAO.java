package com.Dolphin.BgLocation.data.sqlite;
...
import com.Dolphin.BgLocation.data.Location;
...
public class SQLiteLocationDAO implements LocationDAO {
	...
	private Location hydrate(Cursor c) {
		...
		l.setRecordedAt((c.getString(c.getColumnIndex("recordedAt"))));
	...
	private ContentValues getContentValues(Location location) {
		...
		values.put("recordedAt", location.getRecordedAt());	
